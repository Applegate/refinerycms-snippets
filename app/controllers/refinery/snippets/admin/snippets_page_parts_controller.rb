    ...
    module Admin
      class SnippetsPagePartsController < ::Refinery::AdminController
        ...
        def add
          ...
          @snippet = Refinery::Snippets::Snippet.find(params[:snippet_id])
          before_body = params[:before_body] == 'true' ? true : false

          sp = Refinery::Snippets::SnippetPagePart.new(:page_part => @part, :snippet => @snippet, :before_body => before_body)
        ...
        def remove
          ...
          sp = Refinery::Snippets::SnippetPagePart.where(:page_part_id => @part, :snippet_id => @snippet, :before_body => before_body)
